...
int _noteModelEstimateSize(
  ...
  bytesCount += 3 + object.noteTxt.length * 3;
  return bytesCount;
}
...
void _noteModelSerialize(
  ...
  writer.writeString(offsets[0], object.noteTxt);
}
...
NoteModel _noteModelDeserialize(
  ...
  object.id = id;
  object.noteTxt = reader.readString(offsets[0]);
  return object;
}
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtEqualTo(
    String value, {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> noteTxtIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'noteTxt',
        value: '',
...
extension NoteModelQuerySortBy on QueryBuilder<NoteModel, NoteModel, QSortBy> {
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByNoteTxt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteTxt', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByNoteTxtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteTxt', Sort.desc);
    });
  }
}
...
extension NoteModelQuerySortThenBy
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByNoteTxt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteTxt', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByNoteTxtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteTxt', Sort.desc);
    });
  }
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByNoteTxt(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'noteTxt', caseSensitive: caseSensitive);
    });
  }
}
...
extension NoteModelQueryProperty
  ...
  QueryBuilder<NoteModel, String, QQueryOperations> noteTxtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'noteTxt');
    });
  }
}
